...
declare class Clusterer implements google.maps.OverlayView {
    markers: MarkerExtended[];
    clusters: Cluster[];
...
export { Cluster, ClusterIcon, type ClusterIconInfo, type ClusterIconStyle, Clusterer, type ClustererOptions, type MarkerExtended, type TCalculator };
